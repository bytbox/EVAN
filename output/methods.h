...
void plain_contour(FILE *, const char **, int, int, double[]);
...
void ascii_contour(FILE *, const char **, int, int, double[]);
...
void plot_contour(FILE *, const char **, int, int, double[]);
...
void root_contour(FILE *, const char **, int, int, double[]);
